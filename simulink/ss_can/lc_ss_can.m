...
m.blocks(1).pin  = 0;
m.blocks(1).outputs = {'data', 'dlc', 'valid'};
...
m.blocks(2).pin  = 0;
m.blocks(2).inputs  = {'data'};
m.blocks(2).outputs = {'value'};
...
m.blocks(5).pin  = 0;
m.blocks(5).inputs  = {'data'};
m.blocks(5).outputs = {'value'};
...
m.blocks(3).pin  = 0;
m.blocks(3).inputs  = {'data', 'value'};
m.blocks(3).outputs = {'data'};
